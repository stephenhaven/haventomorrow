...
<fieldset>
	<div class="wc-authorize-net-aim-new-payment-method-form js-wc-authorize-net-aim-new-payment-method-form">
		<p class="form-row form-row-first">
			...
			<input type="text" class="input-text js-wc-payment-gateway-account-number" placeholder="&#8226&#8226&#8226&#8226 &#8226&#8226&#8226&#8226 &#8226&#8226&#8226&#8226 &#8226&#8226&#8226&#8226" id="wc-authorize-net-aim-account-number" name="wc-authorize-net-aim-account-number" maxlength="19" autocomplete="off" value="<?php echo esc_attr( $payment_method_defaults['account-number'] ); ?>" />
		</p>
