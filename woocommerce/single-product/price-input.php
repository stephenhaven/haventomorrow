...
<div class="nyp" <?php echo WC_Name_Your_Price_Helpers::get_data_attributes( $product_id, $prefix ); ?> >
	...
	<label for="nyp">
			...
			<?php //printf( _x( '%s ( %s )', 'In case you need to change the order of Name Your Price ( $currency_symbol )', 'wc_name_your_price' ), stripslashes ( 'Other' ), get_woocommerce_currency_symbol() ); ?>
	</label>
	...
	<?php 
		...
		echo WC_Name_Your_Price_Helpers::get_price_input( $product_id, $prefix ); 
	?>
