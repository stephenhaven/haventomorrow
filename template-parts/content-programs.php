...
$noSongsFile = "http://f3.haventoday.org/audio/ns/" . date("mdY", strtotime($program_date)) . 'HavenTodayNS.mp3';
$noSongsExists = false;
...
echo '<div class="item">';
echo '<div class="button trans play" data-playing="0" data-username="haven" data-podcast="' . $event . '"><span class="play">icon</span></div>';
if ($noSongsExists){
